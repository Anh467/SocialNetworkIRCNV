...
public final class UserReports_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 UserReport elem;
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                            <h4 class=\"page-title pull-left\">UserReports</h4>\n");
      out.write("                            <ul class=\"breadcrumbs pull-left\">\n");
      out.write("                                <li><a href=\"index.html\">Home</a></li>\n");
      out.write("                                <li><span>UserReports</span></li>\n");
      out.write("                            </ul>\n");
      out.write("                        </div>\n");
      out.write("                    </div>\n");
      out.write("                ");
      ...
      out.write("                                                <th>Number Reported of Comment</th>\n");
      out.write("                                                <th>Number Reported of Post</th>\n");
      out.write("                                                <th>Number Reported of User</th>\n");
 ...
 UserReportDAO e = new UserReportDAO();
      ...
      out.write("</td>\n");
      out.write("                                            <td>");
      out.print( elem.getNumCommentReported());
      out.write("</td>\n");
      out.write("                                            <td>");
      out.print( elem.getNumPostReported());
      out.write("</td>\n");
      out.write("                                            <td>");
      out.print( elem.getNumReportedByUsers());
      out.write("</td>\n");
      out.write("                                            <td>Delete/Lock/<a href=\"#\" onclick=\"skipRow(this, '");
      out.print( elem.getUserID());
      out.write("')\">Skip</a></td>\n");
      out.write("                                        </tr>\n");
      out.write("                                        ");
      ...
      out.write("                                            alert('Thành công');\n");
      out.write("                                        }\n");
      out.write("                                        function deleteDB(link, id) {\n");
      out.write("                                            var data = {\n");
      out.write("                                                id: id,\n");
      out.write("                                            };\n");
      out.write("\n");
      out.write("                                            $.ajax({\n");
      out.write("                                                url: '../DeleteUserReport',\n");
      out.write("                                                type: 'POST',\n");
      out.write("                                                data: data,\n");
      out.write("                                                success: function (response) {\n");
      out.write("                                                    // Xử lý phản hồi từ servlet nếu cần\n");
      out.write("                                                    console.log('Yêu cầu thành công');\n");
      out.write("                                                    skipRow(link, id);\n");
      out.write("                                                },\n");
      out.write("                                                error: function (xhr, status, error) {\n");
      out.write("                                                    // Xử lý lỗi nếu có\n");
      out.write("                                                    console.log('Lỗi yêu cầu: ' + error);\n");
      ...
      out.write("                                            });\n");
      out.write("                                        }\n");
      out.write("                                        function deleteRow(link, id) {\n");
      out.write("                                            deleteDB(link,id)\n");
      out.write("                                        }\n");
      out.write("                                    </script>\n");
