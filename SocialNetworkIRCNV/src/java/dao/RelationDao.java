...
public class RelationDao {
    ...
    private final String isfriend = "<button type = \"button\" onclick=\"relate('unfriend',<%=UID%>')\">"
    ...
    private final String request = "<button type = \"button\" onclick=\"relate('unrequest','<%=UID%>')\" >"
    ...
    public String getSentRequest(String User, String OtherUser) {
        return "<button type = \"button\" onclick=\"relate('unrequest','" + OtherUser + "')\" >"
                + "<div style='color: black'>"
                + "<i class='fa-solid fa-people-arrows'></i> Sent Requested "
                + "</div>";
    }
    // onclick="relate('addfriend')" rqfr: request friend
    private final String isNotFriend = "<button type = \"button\" onclick=\"relate('requestfriend','<%=UID%>')\" >"
            + "<div style='color: black'>"
    ...
    public String getIsNotFriend(String User, String OtherUser) {
        return "<button type = \"button\" onclick=\"relate('addfriend','" + OtherUser + "')\" >"
                + "<div style='color: black'>"
                + "<i class=\"fa-sharp fa-solid fa-user-plus\"></i> Add friend "
                + "</div>"
                + "</button>";
    ...
    private final String acceptRequest = "<button type = \"button\" onclick=\"relate('requestfriend','<%=UID%>')\" >"
            + "<div style='color: black'>"
    ...
    public String getAcceptRequest(String User, String OtherUser) {
        return "<button type = \"button\" onclick=\"relate('requestfriend','" + OtherUser + "')\" >"
                + "<div style='color: black'>"
                + "<i class=\"fa-sharp fa-solid fa-arrow-right\"></i> Acppect request "
                + "</div>"
                + "</button>";
