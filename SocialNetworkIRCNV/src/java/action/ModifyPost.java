...
public class ModifyPost extends HttpServlet {
    ...
    public void updatePost(String PostID, String UserID, String Content, String ImagePost, String PublicPost) {
        ...
        new dao.PostUserDAO().updatePost(PostID, UserID, Content, ImagePost, PublicPost);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (part != null && part.getSubmittedFileName() != null) {
                ...
                new dao.PostUserDAO().updatePost(PostID, id, content, data.getFilename(), isPublic);
                ...
                new dao.PostUserDAO().updatePost(PostID, id, content, isPublic);
            }
